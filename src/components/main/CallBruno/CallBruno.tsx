...
export const CallBruno = () => {
    ...
    return (
        <div className="m-auto w-fit font-imfell relative">
            <div className={`border-gray-300 border-[3px] border-dashed rounded-full w-[272px] h-[272px] md:w-80 md:h-80 absolute ${!hover ? "animate-spin" : "animate-none"} transition-all`}></div>
            <div
