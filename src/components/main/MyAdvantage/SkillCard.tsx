...
const SkillCard: React.FC<{skill: MyAdv; isFirst: boolean}> = ({skill, isFirst}) => (
    <div className={`flex flex-col items-center hover:text-blue-500 ${isFirst ? "" : "grayscale hover:grayscale-0"}`}>
